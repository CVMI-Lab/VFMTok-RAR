...
import vfmtok.modules.pretrained_enc.dino.vits as dino_vits
import vfmtok.modules.pretrained_enc.ibot.vits as ibot_vits
import vfmtok.modules.pretrained_enc.deit.vits as deit_vits
import vfmtok.modules.pretrained_enc.moco_v3.vits as moco_vits
from .dino_v2.backbones import dinov2_vitb14 as dinov2_vitb
from .dino_v2.backbones import dinov2_vitb14_reg as dinov2_vitb14_reg
from .dino_v2.backbones import dinov2_vitl14_reg as dinov2_vitl14_reg
from .dino_v2.backbones import dinov2_vitg14_reg as dinov2_vitg14_reg
...
def load_pretrained_dino_v2(model, ckpt_path):
    
    assert osp.exists(ckpt_path)
    print(f'Loading {ckpt_path} to initialize DINO-v2 model.')
